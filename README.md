...
![Python](https://img.shields.io/badge/Python-3.11-2a9d8f?style=flat-square)
![pandas](https://img.shields.io/badge/pandas-2.0-2a9d8f?style=flat-square)
![matplotlib](https://img.shields.io/badge/matplotlib-3.11-1a5c5c?style=flat-square)
![seaborn](https://img.shields.io/badge/seaborn-0.13-1a5c5c?style=flat-square)
...
By 2018 it had overtaken Switzerland, Norway and Denmark to claim 1st place,
...
GDP (r = 0.79), Health (r = 0.74), Social Support (r = 0.65), and Freedom
(r = 0.55). It also maintains one of the lowest corruption scores in the
world, with citizens reporting extremely high trust in public institutions.
